...
class ApplicationTests {
	...
	private static final String AWS_URL = "https://o3m5qixdng.execute-api.us-east-1.amazonaws.com/api/managers";
	...
	public void testValidUserRegistration() throws JSONException {
		JSONObject responseJson = webClient
				.post()
				.uri(BASE_URL + "/submit")
		...
		JSONAssert.assertEquals(expectedJson.toJSONString().replaceAll("\"(\\d{1})\"", "$1"),
				responseJson.toJSONString(), false);
